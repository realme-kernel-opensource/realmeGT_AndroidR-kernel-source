...
int dsi_panel_loading_effect_mode_unlock(struct dsi_panel *panel, int mode)
{
	...
	case PANEL_LOADING_EFFECT_MODE1:
		/* ZhongLiuhe@MULTIMEDIA.DISPLAY.LCD.FEATURE, 2021/01/27, Add for loading effect cmd compatibility */
...
int dsi_display_seed_mode(struct dsi_display *display, int mode)
{
	...
	/* Fox.zhang@MULTIMEDIA.DISPLAY.LCD.FEATURE, 2021/03/2, Add for loading effect cmd lock */
