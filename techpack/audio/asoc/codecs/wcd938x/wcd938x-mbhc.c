...
//Nan.Zhong@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2019/11/01, Modify for removing impedance detection
					  ...
					  bool enable)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	//Nan.Zhong@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2019/11/01, Remove for not set L/R 100K, avoid plug in noise
		snd_soc_component_update_bits(component, WCD938X_HPH_PA_CTL2,
				    0x40, 0x00);
		snd_soc_component_update_bits(component, WCD938X_HPH_PA_CTL2,
				    0x10, 0x00);
