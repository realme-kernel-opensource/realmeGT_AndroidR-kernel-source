...
struct kernel_grip_info {
	...
	struct grip_point_info first_point[TOUCH_MAX_NUM];
	/*store the fist point of each ID*/
	...
	struct list_head  large_zone_list;
	/*list all area using large area grip strategy*/
	struct list_head condition_zone_list;
	/*list all area using conditional grip strategy*/
