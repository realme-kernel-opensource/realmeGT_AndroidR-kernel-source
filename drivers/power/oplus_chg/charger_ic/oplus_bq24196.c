...
*/	
	...
	/*
	if(oplus_gauge_check_chip_is_null() || (chip->warp_project && oplus_warp_check_chip_is_null()) 
		|| oplus_pmic_check_chip_is_null())
	{
		chg_err("[oplus_chg_init] warp || gauge || pmic not ready, will do after bettery init.\n");
		return -EPROBE_DEFER;
	}
	*/
